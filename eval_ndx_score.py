...
def compute_mindcf_sre08(fnr, fpr):
    """ computes the minimum detection cost function 2008 given FNR and FPR values calculated
        for a range of operating points on the DET curve
    """
    p_tgt = 0.01
    c_miss = 10
...
def compute_mindcf_sre10(fnr, fpr):
    """ computes the minimum detection cost function 2010 given FNR and FPR values calculated
        for a range of operating points on the DET curve
    """
    p_tgt = 0.001
    c_miss = 1
...
def compute_mindcf_sre12(fnr, fpr):
    """ computes the minimum detection cost function 2012 given FNR and FPR values calculated
        for a range of operating points on the DET curve
    """
...
def compute_mindcf_sre14(fnr, fpr):
    """ computes the minimum detection cost function 2014 given FNR and FPR values calculated
        for a range of operating points on the DET curve
    """
    ratio = 100
...
def compute_mindcf_sre16(fnr, fpr):
    """ computes the minimum detection cost function 2016 given FNR and FPR values calculated
        for a range of operating points on the DET curve
    """
...
def eval_ndx_score(fkey, flabel, fndx, fscore):
    ...
    print("total : {0:d}, target: {1:d}, impostor: {2:d}".format(tgt_num + imp_num, tgt_num, imp_num))
    print("eer = {0:.2f} %".format(100 * eer))
    print("mindcf_sre08 = {0:.4f}".format(mindcf_sre08))
    print("mindcf_sre10 = {0:.4f}".format(mindcf_sre10))
    print("mindcf_sre12 = {0:.4f}, mindcf1 = {1:.4f}, mindcf2 = {2:.4f}".format(mindcf_sre12, mindcf_1, mindcf_2))
    print("mindcf_sre14 = {0:.4f}".format(mindcf_sre14))
    print("mindcf_sre16 = {0:.4f}, mindcf1 = {1:.4f}, mindcf2 = {2:.4f}".format(mindcf_sre16, mindcf_1, mindcf_2))
    print("comment : ")
    print("{0:.4f}, {1:.4f}, {2:.4f}, {3:.4f}, {4:.4f}, {5:.4f}".format(100 * eer, mindcf_sre08, mindcf_sre10, mindcf_sre12, mindcf_sre14, mindcf_sre16))
...
if __name__ == '__main__':
	...
	eval_ndx_score("nist_sre10_trial_coreext_coreext_key.ndx", "nist_sre10_trial_coreext_coreext_c5_female.ndx.label", "nist_sre10_trial_coreext_coreext_c5_female.ndx", "ivec-dlpp-nist_sre10_trial_coreext_coreext_c5_female.score")
